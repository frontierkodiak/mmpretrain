...
class MultiTaskImageClassificationInferencer(BaseInferencer):
    ...
    def postprocess(self,
        ...
        for data_sample in preds:
            ...
            for task_name, pred_scores in data_sample.items():
                ...
                if self.classes is not None and task_name in self.classes:
                    task_result['pred_class'] = self.classes[task_name][pred_label]
    ...
    def list_models(pattern: Optional[str] = None):
        ...
        """
        return list_models(pattern=pattern, task='MultiTask Image Classification')
