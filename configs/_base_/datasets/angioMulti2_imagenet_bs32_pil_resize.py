...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/peach/NA_angiospermae_min180all_cap1500_Jul23/224_90q/train/labels_filt_min350_max1000_verified.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/peach/NA_angiospermae_min180all_cap1500_Jul23/224_90q/val/labels_filt_min350_max50_verified.json',
