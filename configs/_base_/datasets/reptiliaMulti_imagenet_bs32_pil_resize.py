...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/peach/NA_reptilia_min500rg_cap2500/224_90q/train/verified_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/peach/NA_reptilia_min500rg_cap2500/224_90q/val/verified_val.json',
