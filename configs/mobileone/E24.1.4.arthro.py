_base_ = [
    '../_base_/models/mobileone/mobileone_s2_arthroMulti2_raw.py',
    '../_base_/datasets/arthroMulti2_imagenet_bs32_pil_resize.py',
...
train_dataloader = dict(batch_size=1000)
val_dataloader = dict(batch_size=900)
test_dataloader = dict(batch_size=900)
