    ...
    with TemporaryDirectory() as tmpdir:
        ...
        args = Namespace(
            **{
                ...
                'handler': f'{Path(__file__).parent}/mmpretrain_multitask_handler.py',
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Extra files to be included in the package.'
    )
...
if __name__ == '__main__':
    ...
    mmpretrain2torchserve(args.config, args.checkpoint, args.extra_files, args.output_folder,
